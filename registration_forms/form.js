...
function Validate()
{
    ...
    if (document.registration_form.phone_number_1.value == '') 
    {
        alert('Please fill in your entire phone number!');
        return false;
    }
    if (document.registration_form.phone_number_2.value == '') 
    {
        alert('Please fill in your entire phone number!');
        return false;
    }
    if (document.registration_form.phone_number_3.value == '') 
    {
        alert('Please fill in your entire phone number!');
        return false;
    }
